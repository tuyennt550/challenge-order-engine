...
INSERT INTO coupons (code, discount_amount, active, expiry_date)
VALUES
    ('SUMMER10',10,TRUE,CURRENT_TIMESTAMP + INTERVAL '30 days'),
    ('SAVE20',20,TRUE,CURRENT_TIMESTAMP + INTERVAL '30 days');